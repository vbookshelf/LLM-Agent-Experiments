...
<html lang="en">
	...
	<meta charset="utf-8">
	<title>English practice chatbot</title>
...
/*Cellphone Screens in portrait*/
 ...
 .container {
  ...
  <body>
	...
	<p class="w3-small"><span class="w3-padding-left w3-padding-right"><a href="https://woza.work/" target="_blank">Woza.Work</a></span><a href="" target="_blank">GitHub</a></p>
    ...
    <div class="container w3-animate-opacity">
		...
		-->
			<h4 class="space-letters"><b>Gemini English Practice Chatbot</b><br><span class="w3-text-teal">Learn English by chatting with Ai</span></h4>
		</div>
      ...
      <div class="sticky-bar">
		...
		<form id="myForm" action="api-code.php" method="post">
